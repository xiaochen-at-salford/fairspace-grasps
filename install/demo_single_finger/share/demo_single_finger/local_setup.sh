...
: ${AMENT_CURRENT_PREFIX:="/fairspace/install/demo_single_finger"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/demo_single_finger/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/demo_single_finger/environment/path.sh"
