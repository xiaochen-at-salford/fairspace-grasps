...
: ${AMENT_CURRENT_PREFIX:="/fairspace/install/barrett_hand_description"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/barrett_hand_description/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/barrett_hand_description/environment/path.sh"
