...
export RCFILES_DIR="/opt/fairspace/rcfiles"
export FAIRSPACE_DIST="${FAIRSPACE_DIST:-stable}"

export PKGS_DIR="/opt/fairspace/pkgs"
export SYSROOT_DIR="/opt/fairspace/sysroot"

export APOLLO_PROFILE="/etc/profile.d/fairspace.sh"
export APOLLO_LD_FILE="/etc/ld.so.conf.d/fairspace.conf"
export DOWNLOAD_LOG="/opt/fairspace/build.log"
